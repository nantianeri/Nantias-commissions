...
function renderDiscountAnnouncement(discounts=[],isOpen=true){
 ...
 banner.innerHTML=`<div class="global-discount-inner"><span class="global-discount-pulse" aria-hidden="true"></span><div><strong>COMMISSION SALE · ${value}</strong><span>${d.name?String(d.name):'A special discount is currently active'} — applies to all fixed-price commission offers.</span></div><a href="commissions.html">View offers →</a></div>`;
